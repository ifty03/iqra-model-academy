...
const Contact = () => {
  return (
    <div className="lg:w-10/12 w-11/12 mx-auto  my-20 grid md:grid-cols-2 grid-cols-1 lg:gap-10 gap-5">
      <div>
        <iframe
        ...
        <div className="space-y-4 text-sm mt-5">
          ...
          <div className="md:flex items-center gap-5 hidden">
            ...
            <p className="text-lightGray">iqramodelacademychitoshi@gmail.com</p>
          </div>
        </div>
      </div>
